...
namespace Vethentia.Web.Controllers.MVC
{
    using System;
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IUserService userService, IMerchantService merchantService, INotificationService notificationSvc)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    if (addUserResult.Succeeded)
                    {
                        ...
                        // Send SMS to phone
                        await this.UserManager.SendSmsAsync(user.Id, "Vethentia Phone code is " + phoneCode);
                    }
